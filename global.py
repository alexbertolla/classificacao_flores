...
for training_name in train_labels:
    ...
    for x in range(1, images_per_class+1):
        ...
        fv_halarick = fd_halarick(image)
        fv_histogram = fd_color_histogram(image)

        ####################################
        # concatenating global features
        ####################################

        global_feature = np.hstack([fv_histogram, fv_halarick, fv_hu_moments])
